...
public class KThread {
    ...
    public static void finish() {
        ...
        // FIXME : get the waiting parent ready who called join on this thread
    ...
    public void join() {
        ...
        Lib.assertTrue(this != currentThread);
        // FIXME : code added to assign waiting parent(who calls join on it) and sleep the parent
    ...
    private void run() {
        ...
        Machine.yield();    // Dispatch the CPU to this thread.
    ...
    public static void selfTest() {
        ...
        System.out.println("\n--------------Testing KThread.join initiated------------------\n");

        KThread t2 = new KThread(new PingTest(2));
        System.out.println("forking thread 2...");
        t2.fork();
        t2.join();
        System.out.println("joined with thread 2");

        System.out.println("\n--------------Testing KThread.join finished------------------\n");
    }
    ...
    private KThread waitingParent = null; // for join purpose
}
