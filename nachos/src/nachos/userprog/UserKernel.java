...
public class UserKernel extends ThreadedKernel {
    ...
    public void initialize(String[] args) {
        ...
        //--------block  1 FIXME  : added code
        int numPhysPages = Machine.processor().getNumPhysPages();
        freePagesLock = new Lock();

        // do critical tasks
        freePagesLock.acquire();
        // at first all physical pages are free
    ...
    // FIXME : returns an arraylist of available free pages of size numPages
    public static ArrayList<Integer> acquirePages(int numPages) {
        ...
        freePagesLock.acquire();
        //Lib.assertTrue(numPages <= freePages.size());
    ...
    // FIXME : add all the pages from param in the free page linked list
    ...
    private static Lock freePagesLock;  // you will get null pointer exception if you do new Lock() before initialize()
